    ...
    <div class="welcome-brand mb-8 text-center">
      <div class="relative inline-block">
        <div class="w-20 h-20 flex items-center justify-center">
          <img
            src="$electron/resources/build/logo.png"
            alt=""
            class="w-full h-full drop-shadow drop-shadow-color-gray-300"
          />
        </div>
        <div
      ...
      <div
        class="mt-2 text-sm text-gray-500 dark:text-gray-400 max-w-md space-y-2"
      >
        <div class="">
          <a
            href="https://github.com/FliPPeDround/autoglm.js"
